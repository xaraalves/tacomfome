...
public class SalgadosActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_salgados, container, false);
        return rootView;
    }
...
//        progressDialog.show();
    ...
    private void init() {
        mRecyclerView = (RecyclerView) mView.findViewById(R.id.salgados_recycler_view);
        ...
        database.child("lojas").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot data : dataSnapshot.getChildren()) {
                    if(data.getValue(Store.class).getTitle().toLowerCase().contains("2")) {
